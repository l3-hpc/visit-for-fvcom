...
#np    ##Add measured data points
#np    #set file open defaults
#np    plainTextOpenOptions = GetDefaultFileOpenOptions("PlainText")
#np    plainTextOpenOptions['First row has variable names'] = 1
#np    plainTextOpenOptions['Lines to skip at beginning of file'] = 0
#np    plainTextOpenOptions['Column for X coordinate (or -1 for none)'] = 0
#np    plainTextOpenOptions['Column for Y coordinate (or -1 for none)'] = 1
#np    plainTextOpenOptions['Column for Z coordinate (or -1 for none)'] = 2
#np    SetDefaultFileOpenOptions("PlainText", plainTextOpenOptions)
